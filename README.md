...
Passionate about building modern, responsive, and scalable web applications using React and TypeScript.

Currently expanding my backend skills with Java & Spring Boot while continuously improving my frontend architecture and problem-solving abilities.
...
* 💻 Frontend React Developer
* ⚛️ Focused on React & TypeScript
* 🌱 Currently learning Java & Spring Boot
* 🍳 Former Chef & Restaurant Manager transitioning into tech
...
Modern Spotify-inspired music platform built with React and TypeScript.

### 🌤 Weather App

Responsive weather application with API integration and dynamic UI.
...
I'm always excited to collaborate on interesting projects, discuss technology, and continue growing as a developer 🚀
